...
# Read the CSV data
data = pd.read_csv("predictions/final_hybrid_price_regressor_l3_m3_w_ETHUSDT_1d.csv")
...
def plot_columns_and_save():
    ...
    file_name = "final_hybrid_price_regressor_l3_m3_w_ETHUSDT_1d_window50.png"
    ...
    plt.plot(data["window_50_max"], label="window_10_max", color="green")
