...
# Read the CSV data
data = pd.read_csv("predictions/final_hybrid_price_regressor_l3_m8_v2_ETHUSDT_1d.csv")
...
def plot_columns_and_save():
    ...
    file_name = "final_hybrid_price_regressor_l3_m8_v2_ETHUSDT_1d_window_50.png"
